...
import com.emrc_transport.R.color;
...
public class LevelActivity extends Activity implements OnClickListener {
	...
	private LinearLayout leve_item_0, leve_item_1, leve_item_2, leve_item_3, leve_item_bg;
	...
	private void reset() {
		...
		leve_item_bg.setOnClickListener(this);
	...
	private void findViewById() {
		leve_item_bg = (LinearLayout) findViewById(R.id.MidLinearLayout);
